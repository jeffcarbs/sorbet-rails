...
Wizard.in_batches.each { |w| T.assert_type!(w, Wizard::ActiveRecord_Relation) }
...
Wizard.all.in_batches.each { |w| T.assert_type!(w, Wizard::ActiveRecord_Relation) }
...
spell_books.in_batches.each { |s| T.assert_type!(s, SpellBook::ActiveRecord_AssociationRelation) }
...
spell_books_query.in_batches.each { |s| T.assert_type!(s, SpellBook::ActiveRecord_AssociationRelation) }
